...
struct Profile {
    ...
    let processBinaries: ((_ randomize: Bool) -> String)?
    ...
    // An optional crash processor that is executed whenever a crash is detected before it is written to disk.
    let optionalCrashProcessor: FuzzingCrashProcessor?
}
